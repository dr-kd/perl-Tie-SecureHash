...
::ok not eval { $::hashref->{__private_c} = "invalid" };
::ok not eval { $::hashref->{_protected_c} = "invalid" };
::ok not eval { $::hashref->{public_c} = "invalid" };
...
::ok eval { $::hashref->{_protected_p} eq "protected_cp" };
::ok eval { $::hashref->{public_p} eq "public_cp" };
...
::NB "STILL CAN'T DECLARE FIELDS WITHOUT CLASS";
::ok not eval { $::hashref->{__private_m} = "invalid" };
::ok not eval { $::hashref->{_protected_m} = "invalid" };
::ok not eval { $::hashref->{public_m} = "invalid" };
